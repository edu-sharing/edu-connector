...
only_office_plugins="${ONLYOFFICE_PLUGINS:-true}"
only_office_force_save_enabled="${ONLYOFFICE_FORCE_SAVE_ENABLED:-false}"
...
sed -i "s|define('ONLYOFFICE_PLUGINS', .*)|define('ONLYOFFICE_PLUGINS', ${only_office_plugins})|g" "${conf}"
sed -i "s|define('ONLYOFFICE_FORCE_SAVE_ENABLED', .*)|define('ONLYOFFICE_FORCE_SAVE_ENABLED', ${only_office_force_save_enabled})|g" "${conf}"
