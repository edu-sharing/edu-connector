...
if(!isset($_POST['formSubmitted'])) {
    ...
    if(empty($_GET['user_id']) || empty($_GET['course_id']) || empty($_GET['resource_link_id'])) {
...
<head>
    ...
    <script src="/eduConnector/etherpad/jquery-1.10.2.min.js"></script>
    <script src="/eduConnector/etherpad/etherpad.js"></script>
    <script src="/eduConnector/etherpad/jquery.cookie.js"></script>
