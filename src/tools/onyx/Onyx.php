...
class Onyx extends \connector\lib\Tool {
    ...
    private function getHash() {
        ...
        $hash-> nodeid = $_SESSION[$this->connectorId]['node']->ref->id;
        $hash-> accessToken = $_SESSION[$this->connectorId]['oauth_access_token'];
        $hash-> refreshToken = $_SESSION[$this->connectorId]['oauth_refresh_token'] ;
