...
<html lang="en">
    ...
    <head>
		...
		<link rel="stylesheet" href="http://appserver9.metaventis.com/eduConnector/css/screen.css">
    ...
    <body>
		...
		<div id="topbar"><h1>edu-sharing Onlyoffice Konnektor</h1></div>
         <!--<div class="main-panel">
           <span class="portal-name">ONLYOFFICE™ Online Editors</span>
			...
			<div id="content">
			<p>Wählen Sie, welchen Typ von Office-Datei Sie erstellen möchten.</p>
            <ul class="try-editor-list">
                <li><a class="try-editor document" href="doceditor.php?type=document" target="_blank">Textdokument</a></li>
                <li><a class="try-editor spreadsheet" href="doceditor.php?type=spreadsheet" target="_blank">Tabellendokument</a></li>
                <li><a class="try-editor presentation" href="doceditor.php?type=presentation" target="_blank">Präsentation</a></li>
            </ul>
			</div>
          <!--  <br />
            <br />
